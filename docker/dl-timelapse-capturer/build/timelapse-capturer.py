...
CAMERA_API_URL = os.environ.get("CAMERA_IMG_URL")
...
CAMERA_API_USER = os.environ.get("CAMERA_USER")
CAMERA_API_PASSWORD = os.environ.get("CAMERA_PASSWORD")

# Save Path
IMG_SAVE_PATH = os.environ.get("IMG_SAVE_PATH", "/data")
